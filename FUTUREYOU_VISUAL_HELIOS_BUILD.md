...
❯ selfie capture flow. where you place the action is determined by how compltee   
  ...
  questiions for example, so it stays consitent.                                  
...
❯ how about insterting a request for existing content or posts with the creator   
